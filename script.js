...
const closeModal = function () {
  ...
  if (mobileNav.classList.contains('hidden')) overlay.classList.add('hidden');

  if (this.classList.contains('close-modal')) return;
...
document.querySelectorAll('.nav__links').forEach(navLink => {
